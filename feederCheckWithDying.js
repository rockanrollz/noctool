...
function submitFeeder()
{
	...
	var userNo,DyingNo;
	var userOnline = " ONU Online Alarm น่าจะค้าง";
	if(Status != false)
	{
			 ...
			 $.ajax({
						...
						try{
							...
							if( userNo > 2 )
							{
									if(userNo == DyingNo)
									{
										userNo = userNo.fontcolor("green");
										
										document.getElementById("resultP").innerHTML +=  result[2] +userNo+" Dying="+DyingNo+"<br />";
									}
									else
										document.getElementById("resultP").innerHTML +=  result[2] +userNo.fontcolor("red")+" Dying="+DyingNo+"<br />";
								 // document.getElementById("resultP").innerHTML +=  result[2] +userNo+" Dying="+DyingNo+"<br />";
							}	
							else
							{
						...
						{
							document.getElementById("resultP").innerHTML +=  "Node down!!<br />";
						}
						},
